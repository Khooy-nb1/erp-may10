...
export const ENTERPRISE_MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'production-mrp',
        title: 'Nhu cầu nguyên phụ liệu',
        path: '/production?tab=mrp',
        icon: 'ShoppingCart',
        permission: 'production.view',
      },
      {
