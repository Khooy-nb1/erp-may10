  ...
  return createPortal(
    <>
      ...
      <div
        ...
        tabIndex={-1}
        className={cn(
          'sales-overlay-root fixed left-1/2 top-1/2 z-50 w-[calc(100vw-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-brand-border bg-white p-5 shadow-md',
          className
        )}
      >
