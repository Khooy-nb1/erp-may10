...
-- 4. Bổ sung trường kiểm định chất lượng và theo dõi cập nhật vào chi_tiet_don_mua
...
ALTER TABLE chi_tiet_don_mua ADD COLUMN IF NOT EXISTS ngay_cap_nhat TIMESTAMPTZ DEFAULT NOW();
ALTER TABLE chi_tiet_don_mua ADD COLUMN IF NOT EXISTS nguoi_cap_nhat BIGINT;
